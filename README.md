...
> [!TIP]
>  This hack basically hooks right before you load the model into the scene. Possibly there is a chance to have your own fork of three.js to have few more layers of security, or for example displaying scene using random chunks.
